...
console.log(greaterThanSum([5, 8, 18, 32, 67, 131, 265, 529, 1056, 2115]), true);
console.log(greaterThanSum([8, 29, 62, 115, 232]), true);
console.log(greaterThanSum([5, 7, 15, 52, 88, 173, 346, 686, 1393, 2765]), false);
...
console.log(greaterThanSum([8, 31, 39, 102, 176, 363, 732, 1455, 2917, 5840]), false);
...
console.log(greaterThanSum([24, 29, 58, 115, 236, 468, 950, 1905, 3787, 7575]), true);
