...
[{name:"user"}, {name: "persona"}].findIndex("user");
[{name:"user"}, {name: "persona"}].indexOf((eachElement) => {
  return eachElement.name === "user"
});

/* The code is adding event listeners to the 'click' event on the document object. */
